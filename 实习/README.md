...
3. 负责算法模块在安卓、ios终端，及向GPU异构平台的移植、优化、集成；
  ...
  职位要求
4. 精通去噪、平滑、锐化、增强、边缘提取等图像处理算法；
5. 精通图像特征提取、检测识别，对模型的参数调优有丰富的实战经验；
6. 熟悉Caffe/Caffe2、TensorFlow、PyTorch、DeepLearning4j等至少一种深度学习开源框架；
...
1、负责新制造供应链需求预测业务领域的模型建立与优化，在对业务、场景和用户深刻理解的基础上，能将业务问题抽象为数据问题，并通过建模解决。
2、负责面向大数据与人工智能时代供应链库存及产能的预测与决策支持；

3. 负责多维数据集市的规划与设计、业务数据报表需求分析、设计、落地，为业务及管理层提供决策支持与业务分析；
  4、能为团队引入创新的技术和方案，用创新的思路解决问题，能对现存或未来系统进行宏观的思考，规划形成统一的框架、平台或组件；
  5、关键技术攻坚项目的带头人，疑难问题的终结者。
  职位要求
4. 对数据敏感，能从数据中发现问题、解决问题；
5. 能够熟练的使用SQL进行数据获取和分析，并独立地完成分析报告；
6. 能够使用常用的BI算法，如神经网络、逻辑回归、决策树等，能理解业界常用的各类数据分析模型及算法，熟悉Python/R等编程语言优先；
7. 思维清晰，逻辑性强，有强烈的好奇心，勇于创新和面对挑战，对工作充满激情，并有良好的沟通能力、自学能力和团队协作精神。
...
1、熟悉React等主流Javascript框架，对它们适用的范围及优劣有独到见解.

2、了解至少一门非Web前端语言，对前后端合作模式有深入了解并有项目经验

3、善于沟通，有良好的文档写作能力，口头沟通能力，良好的团队合作精神，良好的抽象思维，理性地做出技术决策，具有风险控制意识

4、加分项：

- 精通移动端h5页面开发，拥有丰富的经验，对于移动端混合应用有一定的了解
- 有过数据可视化开发经验，特别是大屏经验，对于SVG、Canvas等有深入的了解，对于业界常用的框架如D3.js等有一定的掌握
- 有3D建模经验，懂WebGL，有threeJS等经验尤佳
- 精通Java或至少一门后端语言
