...
世界估值最高的人工智能独角兽，欢迎移步商汤官网了解详情。

**【组内情况】**

1. 商汤科技核心盈利研发团队， 聚焦生物身份验证、双目/3D 视觉、物体检测等领域核心技术和解决方案。

2. 组内大神多，成员主要来自清华、北大、港中文、北邮等，

3. 技术落地、算法研发双肩挑，每年都会发很多顶会文章，

4. 计算资源丰富，500+ GPUs！妈妈再也不用担心放学后没卡用了，

5. mentor制：会给每个小伙伴配备至少一名【顶会】大神进行研究和工程指导，

6. 团队成员年轻，非常有活力。

**【要求】**

满足以下任一条件即可，实习六个月以上或者有转正意向者优先

1. 算法基础扎实：对计算机视觉、深度学习、机器学习等有深刻理解；

2. 研究课题相关：有AutoML、人脸、双目、目标检测、few shots learning等算法研究背景；

3. 代码实现如飞：有ICPC、CCPC、NOI等比赛奖项，或完整实现或复现过实用、复杂算法；

4. 工程能力强大：实现过实际软硬件系统，能够快速完成系统原型开发；

5. 项目经验丰富：AutoML、人脸、双目、目标检测、few shots learning以及其他相关项目经验；

**【内推方式】**

小伙伴们还等什么！还等什么！赶快行动起来啦。只需将简历投递到yangwukui@sensetime.com, 我们会立即反馈，如有任何问题请随时咨询我们^_^。

注：当天回复，当天内推。

**邮件格式建议：**

1. 邮件主题和简历请按照“CVer推荐+姓名+学校+专业+实习/全职+联系方式”格式填写；

2. 实习应聘，邮件正文还请写上实习起止时间（希望6个月以上），以及每周预计出勤时间，是否有转正意愿。

- 内推邮箱：yangwukui@sensetime.com
